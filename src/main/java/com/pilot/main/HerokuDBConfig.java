...
public class  HerokuDBConfig{
  ...
  public LocalContainerEntityManagerFactoryBean herokuEntityManagerFactory(
    ...
    return builder.dataSource(dataSource).packages("com.pilot.main.herokurepo.domain")
    		.persistenceUnit("pilot_fuel_industry_stats")
    		.persistenceUnit("pfj_fuel_statement")
        .build();
  }
